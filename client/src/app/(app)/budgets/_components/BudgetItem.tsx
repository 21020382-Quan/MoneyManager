          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2 items-center max-w-[150px] overflow-clip">
              ...
              <div>
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger className="font-bold hover:cursor-text select-text" data-testid="budget-name">{budget.name}</TooltipTrigger>
                    <TooltipContent>
                      <p>{budget.name}</p>
                    </TooltipContent>
                  </Tooltip>
            ...
            <h1 className="font-bold text-blue-500" data-testid="budget-amount">{toLocalMoney(budget.amount)}</h1>
          </div>
